...
@ComponentScan(basePackages = "com.ohgiraffers.chap08crudpractice") // basePackages 로 설정된 경로에서 bean 스캔
// basePackages 로 설정된 경로에서 '@Mapper' 어노테이션이 붙은 인터페이스를 스캔하여 MyBatis 매퍼로 등록한다.
@MapperScan(basePackages = "com.ohgiraffers.chap08crudpractice", annotationClass = Mapper.class)
